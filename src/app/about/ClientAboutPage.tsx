...
export const metadata: Metadata = {
  ...
  description:
    "Every family deserves tailored support to feel grounded, balanced and at ease in their daily lives.",
};
          ...
          <div className="flex items-center gap-16 ">
            <div className=" space-y-8 relative ">
              ...
              <p className="text-2xl md:text-3xl text-[#581b04]/60 leading-relaxed font-light">
                Tailored guidance to help you feel grounded, balanced, and at
                ease in daily life
              </p>
            ...
            <div className="lg:col-span-8 space-y-8">
              <div className="prose prose-xl max-w-none">
                <p className="text-2xl text-[#581b04]/80 leading-relaxed font-light mb-8">
                  At Roots & Routines we believe every family deserves tailored
                  support to feel grounded, balanced and at ease in their daily
                  lives.
                </p>

                <p className="text-xl text-[#581b04]/70 leading-relaxed font-light">
                  Our support is parent-led and experience-based. Roots and
              ...
              <div className="relative mt-12 p-10 lg:p-12 rounded-3xl bg-gradient-to-br from-complementary via-[#d4b00b] to-complementary overflow-hidden">
                ...
                <div className="relative">
                  <p className="text-2xl lg:text-3xl text-white leading-relaxed font-light">
                    From school searches to nanny placements, from nutritional
                    meal prep to activity planning—we&apos;re here to take the
                    stress out of the everyday so you can focus on what matters
                    most:{" "}
                    <span className="font-medium italic">
                      connection, calm and quality time.
                    </span>
                  </p>
                </div>
              </div>
      ...
      <section className="px-6 py-24 lg:px-8 lg:py-32 relative overflow-hidden">
        ...
        <div className="mx-auto max-w-[1400px] relative ">
          <div className="text-center mb-16">
            <h2 className="font-quicksand text-4xl lg:text-5xl font-bold text-[#581b04] mb-4">
              Our Core Values
            </h2>
            <p className="text-xl text-[#581b04]/60 font-light">
        ...
        <div className="mx-auto max-w-[1400px] relative ">
          <div className="text-center max-w-3xl mx-auto">
            <div className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-accent/10 border border-accent/20 mb-8">
              ...
              <span className="text-sm font-bold text-accent font-quicksand tracking-wide">
                Our Services
              </span>
            </div>
            ...
            <p className="text-xl text-[#581b04]/60 leading-relaxed font-light mb-12">
              From school searches to nanny placements, from nutritional meal
              prep to activity planning—comprehensive support designed around
              your unique needs
            </p>
