...
export const pagesData = {
  home: {
    ...
    servicesTeaser: {
      title: "Our Services",
      description: "Practical, personalized support for every stage of family life.",
    ...
    contactCTA: {
      title: "Get in Touch",
      description: "Not sure what you need? Start with a call and we'll guide you from there.",
  ...
  contact: {
    meta: {
      ...
      description: "Get in touch with Roots & Routines for personalized family support.",
